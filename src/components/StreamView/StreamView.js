...
import { SnippylyComments, SnippylyCommentsSidebar, SnippylyCommentTool, SnippylyCursor, useSnippylyClient } from '@snippyly/react';
...
const StreamView = ({ setView }) => {
    ...
    return (
        <>
            <Head>
                <title>Snippyly Nextjs Typescript Demo</title>
